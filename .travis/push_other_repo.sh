...
replace_versions bitprim-consensus $BITPRIM_BUILD_NUMBER

cat versions.txt
git add . versions.txt
git commit --message "Travis bitprim-consensus build: $BITPRIM_BUILD_NUMBER, $TRAVIS_BUILD_NUMBER"  || true
